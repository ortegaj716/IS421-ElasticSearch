<?php
/*
require('Elastica/lib/Elastica/Param.php');
require('Elastica/lib/Elastica/Client.php');
require('Elastica/lib/Elastica/Connection/ConnectionPool.php');
require('Elastica/lib/Elastica/Connection/Strategy/StrategyInterface.php');
require('Elastica/lib/Elastica/Connection.php');
require('Elastica/lib/Elastica/Request.php');
*/
...
class ctwitter_stream
{
    ...
    //
    private function process_tweet(array $_data,$json)
    {
        print_r($_data);

		//http_post_data('http://localhost:9200/stream/tweets',$json);
		
		//\Elastica\Client::request('http://localhost:9200/stream/tweets',\Elastica\Request::POST,$json,array());
		
		//open connection                                                                                  
		 
		$ch = curl_init('http://localhost:9200/stream/tweets');                                                                      
